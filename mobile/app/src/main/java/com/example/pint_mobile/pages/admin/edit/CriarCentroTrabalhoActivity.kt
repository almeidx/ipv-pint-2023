...
class CriarCentroTrabalhoActivity : ActivityBase(R.layout.activity_criar_centro_trabalho, "Criar Centro de Trabalho "){
    ...
    fun criarCentroTrabalho(view: View){
        ...
        val postalCode = findViewById<android.widget.EditText>(R.id.postalCodeCentroTrabalhoEditText)
